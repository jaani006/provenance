...
const val WALLET_ADDRESS = "pb1tp4559l0gy6d5cv004gw6a3h3fqd6kcvzqhm6nzfey7p6hxn8qkqd70va9"
val FROM_DATE: LocalDate = LocalDate.of(2023, 1, 1)
val TO_DATE: LocalDate = LocalDate.of(2025, 11, 1)
// -----------------------------
...
interface TransactionClient : BaseClient {
    ...
    fun txsByAddress( // <-- This is the function you will call
        @Param("address") address: String, // <-- Your wallet address is passed here
        @Param("count") count: Int = 10,
        @Param("page") page: Int = 1,
        @Param("msgType") msgType: String? = null,
        @Param("txStatus") txStatus: TxStatus? = null,
        @Param("fromDate") fromDate: LocalDate? = null, // <-- Your start date is passed here
        @Param("toDate") toDate: LocalDate? = null       // <-- Your end date is passed here
    ): PagedResults<TxSummary>
...
// Conceptual class showing how the function would be called with your data
class TransactionService(private val client: TransactionClient) {
    fun getWalletTransactions() {
        // You would typically call this within your application logic
        val transactions = client.txsByAddress(
            address = WALLET_ADDRESS, // "pb1tp4559l0gy6d5cv004gw6a3h3fqd6kcvzqhm6nzfey7p6hxn8qkqd70va9"
            fromDate = FROM_DATE,     // LocalDate.of(2023, 1, 1)
            toDate = TO_DATE,         // LocalDate.of(2025, 11, 1)
            count = 50,               // Optional: Adjust number of results per page
            page = 1                  // Optional: Adjust page number
        )
        // transactions: PagedResults<TxSummary>
    }
}
